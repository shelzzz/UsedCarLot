...
public class UsedCarLot
{
 ...
 public UsedCarLot(){
     c1=(Car) new AutoTransCar(2500,"VW Bug", false, "1D7RV1GT0A5137108", 2017, "Volkswagen", "auto");
     totalValue=c1.getPrice();
     c2=(Car) new AutoTransCar(5000,"Ford Mustang", false, "3HGCG1641XG070722", 2016, "Ford", "auto");
     totalValue+=c2.getPrice();
     c3= (Car) new ManualTransCar(12000,"Honda Fit", 5, "1GNUKKE32AR159343", 2016, "Honda", "manual");
